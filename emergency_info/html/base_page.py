...
def project_base_page():
    ...
    welcome_div.add_element(Header(level=1, internal=f"Welcome to the Emergency Info?!").add_style({'margin': '20px'}))
    welcome_div.add_element(Paragraph(internal=f"""
    Used to remember what to do or keep track of vitals.
